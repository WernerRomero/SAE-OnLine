                    ...
                    <!-- Video -->
                        <div class="text-center">
                            <video width="95%" height="50%" style="margin-top:15px;" controls>
                                <source src="video/webm/tester_analogo.webm" type="video/webm">
                                <source src="video/mp4/tester_analogo.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Tester Analogo</a>
                                        <h4>Uso del Tester Analogo</h4>
                                        <p>
                                            En este video estaremos aprendiendo a utilizar el tester analogo.
                                        </p>
                                </div>
                            </div>
                        </div>
