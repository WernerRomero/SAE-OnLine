                    ...
                    <!-- Video -->
                        <div class="text-center">
                            <video width="75%" height="20%" style="margin-top:15px;" controls>
                                <source src="video/webm/breadboard.webm" type="video/webm">
                                <source src="video/mp4/breadboard.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Uso de Breadboard</a>
                                        <h4>Breadboard</h4>
                                        <p>
                                            En este video estaremos aprendiendo la configuracion y el uso de un elemento muy utilizado en la eléctronica.
                                        </p>
                                </div>
                            </div>
                        </div>
