                    ...
                    <!-- Video -->
                        <div class="text-center">
                            <video width="95%" height="50%" style="margin-top:15px;" controls>
                                <source src="video/webm/circuito_electronico.webm" type="video/webm">
                                <source src="video/mp4/circuito_electronico.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Circuito Eléctrico</a>
                                        <h4>Circuito</h4>
                                        <p>
                                            En este video estaremos aprendiendo algunos circuitos básico de eléctronica.
                                        </p>
                                </div>
                            </div>
                        </div>
