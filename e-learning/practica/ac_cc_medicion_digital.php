                    ...
                    <!-- Video -->
                        <div class="text-center">
                            <video width="95%" height="50%" style="margin-top:15px;" controls>
                                <source src="video/webm/mediciondigital.webm" type="video/webm">
                                <source src="video/mp4/mediciondigital.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Medicion de Tensiones AC y CC con el Tester digital</a>
                                        <h4>Mediciones Tester Digital</h4>
                                        <p>
                                            En este video estaremos aprendiendo a medir tensiones con el tester digital.
                                        </p>
                                </div>
                            </div>
                        </div>
