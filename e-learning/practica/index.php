                    ...
                    <!-- Video -->
                        <div class="text-center">
                            <video width="95%" height="50%" style="margin-top:15px;" controls>
                                <source src="video/webm/simbologia_electronica.webm" type="video/webm">
                                <source src="video/mp4/simbologia_electronica.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Simbologia Eléctrica</a>
                                        <h4>Simbolos</h4>
                                        <p>
                                            En este video estaremos aprendiendo algunos de los simbolos básicos de eléctronica.
                                        </p>
                                </div>
                            </div>
                        </div>
