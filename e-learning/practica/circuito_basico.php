                ...
                <div class="col-xs-12 col-sm-6">
                    <!-- Video -->
                        <div class="text-center">
                            <video width="75%" height="20%" style="margin-top:15px;" controls>
                                <source src="video/webm/circuito_breadboard.webm" type="video/webm">
                                <source src="video/mp4/circuito_breadboard.mp4" type="video/mp4">
                        ...
                        <div class="panel panel-primary aki">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item text-center list-group-item-info " name="El_transistor">Circuito Básico en Breadboard</a>
                                        <h4>Circuito Básico</h4>
                                        <p>
                                            En este video estaremos aprendiendo a realizar un circuito básico utilizando dibersos materiales.
                                        </p>
                                </div>
                            </div>
                        </div>
